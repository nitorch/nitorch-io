...
import numpy as np
# nitorch
from nitorch_io.utils.affine import affine_default
from nitorch_io.utils import py, dtypes, volutils
# io
from nitorch_io.mapping import AccessType
from nitorch_io.utils.indexing import (
    is_fullslice, split_operation, slicer_sub2ind, invert_slice)
