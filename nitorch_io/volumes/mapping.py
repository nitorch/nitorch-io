...
from nitorch_io.utils.affine import affine_sub, affine_permute, voxel_size as affvx
from nitorch_io.utils import dtypes, volutils
from nitorch_io.utils.indexing import (
    expand_index, guess_shape, compose_index, neg2pos,
